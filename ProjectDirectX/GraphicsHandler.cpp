...
bool GraphicsHandler::LoadScene(HWND hwnd)
{
	...
	//Create the lights.
	m_Light = { Vector4(50.0f, 50.0f, 50.0f, 1.0f), Vector4(255.0f, 255.0f, 255.0f, 1.0f), Vector4(255.0f, 255.0f, 255.0f, 1.0f), Vector4(0.0f, 5.0f, -10.0f, 1.0f)/*, Vector4(0, 0, 1, 0)*/ };
